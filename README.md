...
For env setup plz check react native doc.
After cloning repo and installing dependencies. For ios run `cd ios; pod install; cd ..`.
To start app `npm run build-ios or npm run build-android`.
